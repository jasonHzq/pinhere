...
const button = cva("focus-ring inline-flex h-10 cursor-pointer items-center justify-center gap-2 rounded-[9px] border px-4 text-sm font-bold transition-all disabled:pointer-events-none disabled:opacity-45", {
  variants: { variant: { default: "border-[#164dd8] bg-[#164dd8] text-white shadow-[0_5px_16px_#164dd82d] hover:bg-[#255ff0]", outline: "border-[#cbc9c2] bg-[#faf9f5] hover:bg-white", ghost: "border-transparent bg-transparent hover:bg-black/5", danger: "border-[#bb2d3b] bg-[#bb2d3b] text-white" } }, defaultVariants: { variant: "default" }
});
