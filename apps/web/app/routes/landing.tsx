  ...
  return (
    <main className="workspace-grid min-h-screen overflow-hidden">
      ...
      <section className="mx-auto grid max-w-[1220px] gap-12 px-5 pb-24 pt-14 md:px-8 lg:grid-cols-[1.05fr_.95fr] lg:items-center lg:pt-24">
        <div>
          <div className="animate-rise mb-6 flex items-center gap-2 font-mono text-[11px] font-medium uppercase tracking-[.14em] text-[#3d3d39]">
        ...
        <div className="animate-rise delay-2 relative mx-auto w-full max-w-[600px] lg:mx-0">
          ...
          <Card className="overflow-hidden rounded-none border-[#171717] bg-[#171717] text-white shadow-[8px_8px_0_#cfcfca]">
            ...
            <div className="relative aspect-[4/3] bg-[#21211f] p-7">
              ...
              <div className="absolute left-[45%] top-[48%] h-[17%] w-[43%] rounded-[7px] border-2 border-white bg-white/10 shadow-[0_0_0_999px_rgba(2,5,10,.28)]">
                <div className="absolute -top-7 left-0 rounded-md bg-white px-2 py-1 font-mono text-[10px] text-[#151515]">button.checkout</div>
      ...
      <section id="workflow" className="border-y border-[#d6d5ce] bg-[#efefeb]/85">
        <div className="mx-auto grid max-w-[1220px] md:grid-cols-4">
          {t.steps.map((step, index) => {
            ...
            return <div key={step} className="group border-b border-[#d6d5ce] p-7 last:border-b-0 md:border-b-0 md:border-r md:last:border-r-0"><div className="mb-12 flex items-center justify-between"><span className="font-mono text-[11px] text-[#8b8e87]">0{index + 1}</span><Icon size={20} className="text-[#20201e] transition-transform group-hover:rotate-[-8deg] group-hover:scale-110" /></div><h2 className="text-xl font-bold tracking-[-.03em]">{step}</h2></div>;
          })}
        </div>
      </section>

      <section className="mx-auto max-w-[1220px] px-5 py-24 md:px-8">
        <div className="grid gap-8 border-l-4 border-[#171717] pl-6 md:grid-cols-[1fr_auto] md:items-end md:pl-10">
